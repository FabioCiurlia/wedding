    ...
    return (
        <>
            <div className="mb-5 has-text-centered">
                <span className="wrapped-border is-size-5">HOTEL</span>
            </div>
            <div className="content">
                ...
                <p className="has-text-justified">La struttura vi accoglierà a partire da Venerdì 15 dicembre fino a Domenica 17 dicembre, 
                    per permettevi di immergervi completamente nel fascino del barocco leccese e di scoprirne in tutta tranquillità <b className="is-green">Storia</b>, <b className="is-green">Cibo</b> e <b className="is-green">Tradizioni</b>. 
                </p>
            </div>
        </>
    )

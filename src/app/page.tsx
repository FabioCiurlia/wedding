      ...
      <div className="hero" style={{ height: "100vh" }}>
        <div className="hero-body">
          <div className="container">
			...
			<h1 className="is-hidden-mobile names-desktop">
              Andrea e Roberta
            </h1>

			<h1 className="is-hidden-desktop names-mobile">
              Andrea e Roberta
            </h1>
            ...
            <div className="columns is-centered">
              <div className="column is-half">
                <div className="my-5">
                  <p className="has-text-centered is-size-6" style={{lineHeight: 'normal', letterSpacing: '2px'}}>
